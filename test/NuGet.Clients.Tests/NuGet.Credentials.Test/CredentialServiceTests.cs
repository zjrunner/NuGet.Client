...
namespace NuGet.Credentials.Test
{
    ...
    public class CredentialServiceTests
    {
        ...
        public CredentialServiceTests()
        {
            ...
            _mockProvider.Setup(x => x.Get(It.IsAny<Uri>(), It.IsAny<IWebProxy>(), It.IsAny<bool>(), It.IsAny<bool>(),
        ...
        public async Task GetCredentials_PassesAllParametersToProviders()
        {
            ...
            _mockProvider.Verify(x => x.Get(uri, webProxy, /*isProxy*/ true, /*isRetry*/ It.IsAny<bool>(), /*nonInteractive*/ true, CancellationToken.None));
        }
        ...
        public async Task GetCredentials_FirstCallHasRetryFalse()
        {
            ...
            var result1 = await service.GetCredentials(uri1, null, isProxy: false, cancellationToken: CancellationToken.None);
            var result2 = await service.GetCredentials(uri2, null, isProxy: false, cancellationToken: CancellationToken.None);

            _mockProvider.Verify(x => x.Get(uri1, null, /*isProxy*/ false, /*isRetry*/ false, /*nonInteractive*/ false, CancellationToken.None));
            _mockProvider.Verify(x => x.Get(uri2, null, /*isProxy*/ false, /*isRetry*/ false, /*nonInteractive*/ false, CancellationToken.None));
        }
        ...
        public async Task GetCredentials_SecondCallHasRetryTrue()
        {
            ...
            await service.GetCredentials(uri1, null, isProxy: false, cancellationToken: CancellationToken.None);
            await service.GetCredentials(uri1, webProxy, isProxy: false, cancellationToken: CancellationToken.None);

            _mockProvider.Verify(x => x.Get(uri1, null, /*isProxy*/ false, /*isRetry*/ false, /*nonInteractive*/ false, CancellationToken.None));
            _mockProvider.Verify(x => x.Get(uri1, webProxy, /*isProxy*/ false, /*isRetry*/ true, /*nonInteractive*/ false, CancellationToken.None));
        }
        ...
        public void GetCredentials_SingleThreadedAccessToEachProvider()
        {
            ...
            for (var x = 0; x < 10; x++)
            {
                tasks[x]=service.GetCredentials(uri, webProxy, isProxy: false, cancellationToken: CancellationToken.None);
            }
            Task.WaitAll(tasks);
        ...
        public async Task GetCredentials_ReturnesCachedCredential()
        {
            var service = new CredentialService(errorDelegate: TestableErrorWriter, nonInteractive: false)
            {
                Providers = new[] { _mockProvider.Object }
            ...
            _mockProvider
                .Setup(x => x.Get(It.IsAny<Uri>(), It.IsAny<IWebProxy>(), It.IsAny<bool>(),
                It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
                .Returns(Task.FromResult<ICredentials>(credential));
            var uri1 = new Uri("http://uri1");

            var result1 = await service.GetCredentials(uri1, null, isProxy: false, cancellationToken: CancellationToken.None);
            var result2 = await service.GetCredentials(uri1, null, isProxy: false, cancellationToken: CancellationToken.None);

            Assert.Same(result1, credential);
            Assert.Same(result2, credential);
        ...
        public async Task GetCredentials_WhenUriHasSameAuthorityReturnsCachedCredential()
        {
            var service = new CredentialService(errorDelegate: TestableErrorWriter, nonInteractive: false)
            {
                Providers = new[] { _mockProvider.Object }
            ...
            Assert.Same(result2, credential);
            _mockProvider.Verify(
                x => x.Get(It.IsAny<Uri>(), It.IsAny<IWebProxy>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()),
                Times.Once);
        }
    }
}
