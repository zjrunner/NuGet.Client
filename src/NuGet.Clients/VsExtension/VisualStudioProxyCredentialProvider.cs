...
{
    public class VisualStudioProxyCredentialProvider : NuGet.Credentials.ICredentialProvider
    {
        private readonly IVsWebProxy _webProxyService;

        public VisualStudioProxyCredentialProvider(IVsWebProxy webProxyService)
        {
            ...
            bool nonInteractive, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return await PromptForCredentials(uri, cancellationToken);
            }
            finally
            {
