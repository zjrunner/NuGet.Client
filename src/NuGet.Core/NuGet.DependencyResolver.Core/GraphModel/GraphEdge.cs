...
namespace NuGet.DependencyResolver
{
    ...
    {
        public GraphEdge(GraphEdge<TItem> outerEdge, GraphNode<TItem> node, LibraryDependency edge)
        {
            OuterEdge = outerEdge;
            Node = node;
            Edge = edge;
        ...
        /// <summary>
        /// Incoming edge to <see cref="Node"/>.
        /// </summary>
        ...
        /// </summary>
        public GraphNode<TItem> Node { get; }

        /// <summary>
        /// Outgoing edge from <see cref="Node"/>.
        /// </summary>
