...
namespace NuGet.ProjectModel
{
    public class LockFileTargetLibrary : IEquatable<LockFileTargetLibrary>
    {
        ...
        public IList<LockFileItem> SharedContent { get; set; } = new List<LockFileItem>();
        ...
        public bool Equals(LockFileTargetLibrary other)
        {
            ...
            return string.Equals(Name, other.Name)
                ...
                && SharedContent.OrderBy(item => item.Path, StringComparer.OrdinalIgnoreCase)
                    .SequenceEqual(other.SharedContent.OrderBy(item => item.Path, StringComparer.OrdinalIgnoreCase));
        }
        ...
        public override int GetHashCode()
        {
            ...
            foreach (var item in SharedContent.OrderBy(item => item.Path, StringComparer.OrdinalIgnoreCase))
            {
                combiner.AddObject(item);
            }
